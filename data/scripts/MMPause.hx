...
function create(event) {
    ...
    modeTxt.alpha = 0;
    modeTxt.setFormat(Paths.font("MM/marioNES.ttf"),17,FlxColor.WHITE, "Center", FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    add(modeTxt);

    desctext = new FlxText(566, 271, 0, "", 12);
    desctext.text = "Description";
    desctext.alpha = 0;
    desctext.setFormat(Paths.font("MM/marioNES.ttf"), 17);
    add(desctext);
    ...
    descAll.alpha = 0;
    descAll.setFormat(Paths.font("MM/marioNES.ttf"), 17);
    add(descAll);

    title = new FlxText(566, modeTxt.y + 40, 700, songName, 22);
    title.setFormat(Paths.font('MM/marioNES.ttf'), 22);
    title.alpha = 0;
    ...
    levelDifficulty.setFormat(Paths.font('MM/marioNES.ttf'), 17);
    ...
    creditsTxt.alpha = 0;
    creditsTxt.setFormat(Paths.font("MM/marioNES.ttf"), 17);
    add(creditsTxt);

    botplaytxt = new FlxText(1150,690,0,"Botplay", 17);
    botplaytxt.alpha = FlxG.save.data.botplayOption ? 1 : 0;
    botplaytxt.setFormat(Paths.font("MM/marioNES.ttf"), 17);
    add(botplaytxt);
