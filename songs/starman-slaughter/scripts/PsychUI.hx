...
function create() {
    ...
    timeTxt.setFormat(Paths.font("MM/Mario2.ttf"), 22, 0xFFf42626, "center", FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    ...
    hudTxt.setFormat(Paths.font("MM/Mario2.ttf"), 15, 0xFFf42626, "center", FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    ...
    botplayTxt.setFormat(Paths.font("MM/Mario2.ttf"), 32, FlxColor.WHITE, "center", FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
